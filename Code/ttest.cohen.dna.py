...
def getMAFadj(fname,isDriver):
    ...
    if(isDriver):
        ...
        #Now ONLY Train the matrix based on higer VAF
        smaf['VAF'] = smaf['t_alt_count'] / (smaf['t_alt_count']+smaf['t_ref_count'])
        smaf2 = smaf[(smaf['VAF'] >= .1)]
        maf_sub = smaf2[["Hugo_Symbol","Chromosome","Start_Position","Reference_Allele","Tumor_Sample_Barcode","Annotation_Transcript","Protein_Change","COHORT"]]
    return(maf_sub)
